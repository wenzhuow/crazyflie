...
class NatNetClient:
    def __init__( self ):
        ...
        self.serverIPAddress = "192.168.1.101" 

        # Change this value to the IP address of your local network interface
        self.localIPAddress = "192.168.1.104"
...
##            print(self.ts,self.lts)
            if self.ts - self.lts >= 0.15 and self.ts != self.find:
##                pass
##                print("find  ",self.ts,self.lts)
